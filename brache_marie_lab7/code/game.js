...
var actorChars = {
  ...
  "s": Sound //Sound will play when this node is interacted with.
};
...
function Player(pos) {
  this.pos = pos.plus(new Vector(-1.0, -1.0));
...
function Sound(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.5, 0.5));
...
var wobbleSpeedTwo = 18;
var wobbleDistTwo = 0.17;

Sound.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedTwo;
  var wobblePosTwo = Math.sin(this.wobble) * wobbleDistTwo;
  this.pos = this.basePos.plus(new Vector(0, wobblePosTwo));
};
